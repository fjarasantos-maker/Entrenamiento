...
**Semana de descarga desde el 24/08/2026** (dos sesiones seguidas con dolor lumbar + dolor de hombro; el usuario lo atribuye a sobrecarga acumulada). Cambios respecto a la versión anterior:
- En casa se queda solo el dead hang, sin negativas: la negativa y el hang competían por el mismo hombro y agarre, y era demasiado en una sesión. Las negativas y dominadas pasan al día de gimnasio (miércoles). El usuario identifica el agarre como su factor limitante actual, así que el dead hang pasa a ser el foco de mejora con seguimiento formal.
- Se sustituye el puente de glúteo isométrico (dolor lumbar dos sesiones seguidas, incluso con técnica corregida) por la almeja isométrica, que trabaja glúteo medio tumbado de lado, sin cargar la zona lumbar.
- Se sustituyen plancha frontal y bird dog (ambos impedidos por dolor el 24/08) por el dead bug isométrico, que se hace boca arriba con la lumbar pegada al suelo, sin extensión lumbar.
